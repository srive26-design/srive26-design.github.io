...
1. Extract this ZIP and copy the CONTENTS of `portfolio-update` into a local checkout of `srive26-design/srive26-design.github.io` on a new branch. Merge the assets folders, allowing the updated root files to replace their older versions. Do not upload an extra parent folder as the site root.
